...
# Example:
# cd /root/code/pred-vdm/data/SMMNIST
# dataset_root=/root/autodl-tmp/SMMNIST
# python 01_mnist_download_and_convert.py --image_size 64 --mnist_dir $dataset_root --out_dir $dataset_root/SMMNIST_h5 --force_h5 False
