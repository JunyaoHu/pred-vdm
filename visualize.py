...
def visualize(save_path, origin, result, epoch_num=0, cond_frame_num=10, skip_pic_num=1, save_pic_num=8, grid_nrow=4, save_pic_row=True, save_gif=True, save_gif_grid=True):
    ...
    if save_gif_grid:
        ...
        save_path = os.path.join(save_gif_grid_path, f"save_gif_grid_epoch{epoch_num}_sample.gif")
        media.write_video(save_path, final_grids.numpy(), codec='gif', fps=20)
        
        result_path_output.append(save_path)
        
    return result_path_output